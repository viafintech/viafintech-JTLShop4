...
namespace Plugin\s360_barzahlen_shop4\lib\Barzahlen;

use Plugin\s360_barzahlen_shop4\lib\Barzahlen\Request\Request;
...
class Client
{
    ...
    public function checkResponse($response, $contentType)
    {
        if (Middleware::stringIsPrefix('application/json', $contentType)) {
            ...
            $errorMapping = array(
                'auth'              => 'Plugin\s360_barzahlen_shop4\lib\Barzahlen\Exception\AuthException',
                'transport'         => 'Plugin\s360_barzahlen_shop4\lib\Barzahlen\Exception\TransportException',
                'idempotency'       => 'Plugin\s360_barzahlen_shop4\lib\Barzahlen\Exception\IdempotencyException',
                'rate_limit'        => 'Plugin\s360_barzahlen_shop4\lib\Barzahlen\Exception\RateLimitException',
                'invalid_format'    => 'Plugin\s360_barzahlen_shop4\lib\Barzahlen\Exception\InvalidFormatException',
                'invalid_state'     => 'Plugin\s360_barzahlen_shop4\lib\Barzahlen\Exception\InvalidStateException',
                'invalid_parameter' => 'Plugin\s360_barzahlen_shop4\lib\Barzahlen\Exception\InvalidParameterException',
                'not_allowed'       => 'Plugin\s360_barzahlen_shop4\lib\Barzahlen\Exception\NotAllowedException',
                'server_error'      => 'Plugin\s360_barzahlen_shop4\lib\Barzahlen\Exception\ServerException'
            );
