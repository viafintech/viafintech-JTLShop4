    ...
    function resendSlip(slipId) {
        ...
        $.ajax({
            ...
            if (data.result === 'success') {
                message.html('<div class="alert alert-success">Der Zahlschein wurde erneut versendet.</div>');
            } else {
    ...
    function invalidateSlip(slipId) {
        ...
        $.ajax({
            ...
            var page = $("#pagination").data("page");
                loadOrders(page);
            if (data.result === 'success') {
                message.html('<div class="alert alert-success">Der Zahlschein wurde erfolgreich invalidiert.</div>');
            } else {
                message.html('<div class="alert alert-danger">'+data.message+'</div>');
            }
        }).fail(function (jqXHR, textStatus) {
    ...
    function performRefund(slipId) {
        ...
        $.ajax({
            ...
            $(".modal").modal('hide');
                ...
                loadOrders(page);
            if (data.result === 'success') {
                message.html('<div class="alert alert-success">Der Betrag wurde erfolgreich erstattet.</div>');
            } else {
                message.html('<div class="alert alert-danger">'+data.message+'</div>');
            }
        }).fail(function (jqXHR, textStatus) {
